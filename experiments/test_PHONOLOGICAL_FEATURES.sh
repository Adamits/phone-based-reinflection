...
python "$ROOT"/phone-based-reinflection/scripts/conll2onmt-PHONOLOGICAL_FEATURES.py "$LANG" "$ROOT"/phone-based-reinflection/data/"$LANG"-uncovered-test "$ROOT"/phone-based-reinflection/data/onmt-phone-feature-inputs/"$LANG"-test

...
python "$ROOT"/phone-based-reinflection/scripts/phoible2onmt_testfiles.py -i "$ROOT"/phone-based-reinflection/data/pron_data/gold_data_train -o "$ROOT"/phone-based-reinflection/data/opennmt-formatted-pron_data -l $LANG -lc $LANG_CODE

...
python "$ROOT"/phone-based-reinflection/scripts/conll2onmt_POSITIVE_PHONOLOGICAL_FEATURES.py "$LANG" "$ROOT"/phone-based-reinflection/data/"$LANG"-dev "$ROOT"/phone-based-reinflection/data/onmt-phone-feature-inputs/"$LANG"-dev

# Just use high setting
s=high
# Format the train data, and get the g2p
python "$ROOT"/phone-based-reinflection/scripts/conll2onmt_POSITIVE_PHONOLOGICAL_FEATURES.py "$LANG" "$ROOT"/phone-based-reinflection/data/"$LANG"-train-"$s" "$ROOT"/phone-based-reinflection/data/onmt-phone-feature-inputs/"$LANG"-train-"$s"

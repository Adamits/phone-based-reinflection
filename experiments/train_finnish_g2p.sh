...
python "$ROOT"/OpenNMT-py/train.py -data "$ROOT"/phone-based-reinflection/g2p-models/$LANG -save_model "$ROOT"/phone-based-reinflection/g2p-models/$LANG -epochs "$EPOCHS" -encoder_type brnn  -word_vec_size 500 -rnn_size 500 -gpuid 0

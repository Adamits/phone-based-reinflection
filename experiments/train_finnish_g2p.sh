...
python "$ROOT"/OpenNMT-py/train.py -data "$ROOT"/phone-based-reinflection/g2p-models/$LANG -save_model "$ROOT"/phone-based-reinflection/g2p-models/$LANG -epochs "$EPOCHS" -gpuid 0